...
(function() {
  var lax = (function() {
    ...
    const transforms = {
      ...
      "data-lax-rotate-x": function(style, v) { style.transform += ` rotateX(${v}deg)` },
      "data-lax-rotate-y": function(style, v) { style.transform += ` rotateY(${v}deg)` },
      "data-lax-rotate-z": function(style, v) { style.transform += ` rotateZ(${v}deg)` },
